...
export function RecentWithdrawals() {
  ...
  const current = staticWithdrawals[currentIndex];
    ...
    <Card className="border-none bg-white shadow-xl rounded-[2rem] overflow-hidden">
      <div className="bg-muted/30 px-6 py-4 flex items-center justify-between border-b border-muted">
        <div className="flex items-center gap-2">
            ...
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Recent Payouts</h3>
        </div>
        <Badge variant="outline" className="text-[8px] font-black uppercase bg-white border-primary/20 text-primary">LIVE Feed</Badge>
      </div>
      <CardContent className="p-6">
        <div className="relative h-16 overflow-hidden">
            ...
            >
              <div className="h-12 w-12 rounded-2xl bg-primary/5 flex items-center justify-center shrink-0 border border-primary/5">
                <span className="text-lg font-black text-primary/40 leading-none">
              ...
              <div className="flex-1 space-y-0.5">
                ...
                <div className="flex items-center gap-2">
                    <p className="text-[10px] font-bold text-muted-foreground uppercase">Withdrawal Success</p>
                    <div className="h-1 w-1 rounded-full bg-muted-foreground/30" />
                    <p className="text-[10px] font-bold text-green-600 uppercase">Just Now</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-base font-black text-primary tracking-tighter">
                    PKR {current.amount.toLocaleString()}
                </p>
              </div>
            </div>
        </div>
