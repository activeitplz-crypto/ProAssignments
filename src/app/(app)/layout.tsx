      ...
      <nav className="hidden md:fixed md:left-0 md:top-0 md:z-50 md:flex md:h-screen md:w-64 md:flex-col md:border-r md:bg-white md:shadow-2xl md:shadow-slate-200/50">
       ...
       {!isProfilePage && (
         <header className={cn(
           ...
           !isDashboard ? "sticky top-0 bg-white/80 backdrop-blur-md" : "absolute top-0 left-0 right-0 bg-transparent"
         )}>
          <div className={cn("flex items-center gap-2 md:hidden", isDashboard ? "text-white" : "text-slate-900")}>
              ...
              <div className="flex flex-col">
                <span className={cn("text-xs font-black tracking-tighter leading-none italic", isDashboard ? "text-white" : "text-slate-900")}>
                  ProAssignment
                </span>
              </div>
          </div>
