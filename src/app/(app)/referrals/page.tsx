...
export default async function ReferralsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC] space-y-6">
      <div className="bg-primary pt-16 pb-20 px-6 relative rounded-b-[2.5rem] shadow-lg overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 space-y-4">
          <div className="flex items-center justify-center gap-2">
              ...
              <Gift className="h-3 w-3 text-yellow-400/60" />
          </div>
          <h1 className="text-4xl font-black tracking-tighter uppercase italic text-white leading-none">
            Referral <span className="text-white/80">Hub</span>
          </h1>
          <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.2em]">Scale your revenue by building your digital network</p>
        </div>
      </div>

      <div className="px-4 -mt-10 space-y-8 max-w-5xl mx-auto w-full pb-24 relative z-20">
        {uplineInfo && (
