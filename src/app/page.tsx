  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="container mx-auto flex flex-col items-center justify-center space-y-8 px-4 py-12 text-center md:py-24 lg:py-32">
          ...
          <p className="max-w-[700px] text-lg text-muted-foreground md:text-xl">
            Welcome to PlanBase. We provide a clear path to grow your earnings through structured investment plans and a powerful referral system.
          </p>
      ...
      <footer className="container mx-auto px-4 py-6 text-center text-muted-foreground">
        <p>&copy; {new Date().getFullYear()} PlanBase. All Rights Reserved.</p>
      </footer>
    </div>
  );
}
